...
$JSONObject = [System.Text.Encoding]::UTF8.GetString([System.Convert]::FromBase64String($payload))
#Convert JSON Object
$ParameterObject = $JSONObject | ConvertFrom-Json
Write-Output $ParameterObject
...
if($ParameterObject.action -eq "Import-Domain" -or $ParameterObject.action -eq "Import-All") {
  try {
...
if($ParameterObject.action -eq "Import-Users" -or $ParameterObject.action -eq "Import-All") {
  try {
